...
var addTipModal = /*#__PURE__*/function (_Modal) {
  ...
  _proto.content = function content() {
    return m("div", {
      ...
      id: "pay",
      style: "width:100% !important; height:220px; align: center;"
    })));
  } //
  ;
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              console.log(this.div_tip_id['dom']['innerHTML']); //console.log(this.address + ' ' + this.tips_amount + ' user_id = ' + this.user_id + ' post_id = ' + this.post.data.id);
            ...
            case 3:
              ...
              opay.request(req, function (e) {
                ...
                if (result.code == 0) {
                  ...
                  xhttp.open("GET", flarum_app__WEBPACK_IMPORTED_MODULE_4___default.a.forum.attribute('baseUrl') + "/nbdomaintips?user_id=" + _this.user_id + "&post_id=" + _this.post.data.id + "&sender_id=" + _this.sender_id + "&tips_amount=" + _this.tips_amount + "&trx=" + result.txhash, true);
                  xhttp.send();
...
/* harmony import */ var _addTipModal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./addTipModal */ "./src/forum/addTipModal.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_CommentPost__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'footerItems', function (items) {
    ...
    var user = post.user();
    var curruser = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.session.user;
    var vcurruser = 0;
    ...
    console.log('user_id ' + vcurruser); //console.log(user);

    console.log(user['data']['attributes']['opayaddress']);
    var tiplist = "tiplist" + post.data.id;
    var btnlist = "btnlist" + post.data.id;
    var tiplistlabel = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans("chen-nbdomain-login.forum.tip_list");
    var no_tips = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans("chen-nbdomain-login.forum.no_tips");
    items.add('nbdomaintipslist', m("div", {
      className: "NBDomainTipsList"
    }, m("div", {
      id: tiplist
      ...
      onclick: function onclick() {
        console.log(tiplistlabel[0]); //if (document.getElementById(btnlist).innerText === tiplistlabel[0]) {
            ...
            if (datax.length > 0) {
              ...
              for (var i = 0; i < datax.length; i++) {
                ...
                if (datax[i].attributes.senderId === 0) {
                  ...
                  imn = i;
                  flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.store.find('users', datax[i].attributes.senderId).then( //user => dicoba(user)
                  function (user) {
        ...
        xhttp2.open("GET", flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('baseUrl') + "/posts/" + post.data.id + "/nbdomaintipslist?include=user", true);
        xhttp2.send(); //} else {

        document.getElementById(btnlist).innerHTML = '<span>' + tiplistlabel[0] + '</span>'; //}							
      }
    }, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans("chen-nbdomain-login.forum.tip_list"))));
    ...
    if (curruser !== user) {
      items.add('nbdomaintips', m("div", {
        ...
        onclick: function onclick() {
          ...
          flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.modal.show(_addTipModal__WEBPACK_IMPORTED_MODULE_7__["default"], attrs);
          console.log(items.get('nbdomaintips')['children'][2]['attrs']['value']);
          console.log(document.getElementById(tip_text_id).value);
        }
      }, flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans("chen-nbdomain-login.forum.tip_text")), "\xA0", m("input", {
        type: "number",
        id: tip_text_id,
...
flarum_app__WEBPACK_IMPORTED_MODULE_3___default.a.initializers.add('chen-nbdomain-login', function () {
...
function _onLogin() {
  _onLogin = Object(_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee() {
    ...
    var data_sign, name, hash, domain, pubKey, address, reqBody, identification, password, remember;
              ...
              opay.request({
                ...
                if (obj.code == 0) {
                  ...
                  xhttp.onreadystatechange = function () {
                    ...
                    if (this.readyState == 4 && this.status == 200) {
                      console.log("---4");
                      window.location.reload(); //  xhttp2.open("GET", app.forum.attribute('baseUrl') + "/nbdomain-login?userid=" + name, true);
                      //  xhttp2.send();
                  ...
                  xhttp.open("GET", flarum_app__WEBPACK_IMPORTED_MODULE_3___default.a.forum.attribute('baseUrl') + "/nbdomain-login?userid=" + name + "&address=" + address, true);
                  xhttp.send();
                  console.log("---3");
                  /*xhttp2.onreadystatechange = function() {
                  if (this.readyState == 4 && this.status == 200) {
